...
# ** TestUI_UCIcon
#------------------------------------------------------------------------------
#  Unit tests for the UCIcon user control
#==============================================================================

class TestUI_UCIcon < TestUI_Class
  ...
  #--------------------------------------------------------------------------
  # * UCIcon aligned to top/left
  #--------------------------------------------------------------------------
  def test_alignTopLeft
    [@window, @sprite, @bitmap].each{|container|
      uc = UCIcon.new(container, Rect.new(0, 48, @window.contents.width, 72), 1, 0)
      uc.draw()
    }
    return true
  end
  ...
  #--------------------------------------------------------------------------
  # * UCIcon aligned to top/right
  #--------------------------------------------------------------------------
  def test_alignTopRight
    [@window, @sprite, @bitmap].each{|container|
      uc = UCIcon.new(container, Rect.new(0, 48, @window.contents.width, 72), 1, 2)
      uc.draw()
    }
    return true
  end
  ...
  #--------------------------------------------------------------------------
  # * UCIcon aligned to middle/center
  #--------------------------------------------------------------------------
  ...
  #--------------------------------------------------------------------------
  # * UCIcon aligned to middle/right
  #--------------------------------------------------------------------------
  def test_alignMiddleRight
    [@window, @sprite, @bitmap].each{|container|
      uc = UCIcon.new(container, Rect.new(0, 48, @window.contents.width, 72), 1, 2, 255, 1)
      uc.draw()
    }
    return true
  end
  ...
  #--------------------------------------------------------------------------
  # * UCIcon aligned to bottom/left
  #--------------------------------------------------------------------------
  def test_alignBottomLeft
    [@window, @sprite, @bitmap].each{|container|
      uc = UCIcon.new(container, Rect.new(0, 48, @window.contents.width, 72), 1, 0, 255, 2)
      uc.draw()
    }
    return true
  end
  ...
  #--------------------------------------------------------------------------
  # * UCIcon aligned to bottom/center
  #--------------------------------------------------------------------------
  def test_alignBottomCenter
    [@window, @sprite, @bitmap].each{|container|
      uc = UCIcon.new(container, Rect.new(0, 48, @window.contents.width, 72), 1, 1, 255, 2)
      uc.draw()
    }
    return true
  end
  ...
  #--------------------------------------------------------------------------
  # * UCIcon aligned to bottom/right
  #--------------------------------------------------------------------------
...
#~   #--------------------------------------------------------------------------
#~   # * UCIcon with custom direction to left
#~   #--------------------------------------------------------------------------
#~   def test_directionLeft
#~     [@window, @sprite, @bitmap].each{|container|
#~       uc = UCIcon.new(container, Rect.new(300, 24, 24, 24), 1)
#~       uc.direction = 0
#~       uc.draw()
#~     }
#~     return true
...
#~   
#~   #--------------------------------------------------------------------------
#~   # * UCIcon with custom direction to right
#~   #--------------------------------------------------------------------------
#~   def test_directionRight
#~     [@window, @sprite, @bitmap].each{|container|
#~       uc = UCIcon.new(container, Rect.new(400, 24, 24, 24), 1)
#~       uc.direction = 1
#~       uc.draw()
#~     }
#~     return true
