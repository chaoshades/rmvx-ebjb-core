...
# ** TestUI_CEllipse
#------------------------------------------------------------------------------
#  Unit tests for the Ellipse control
#==============================================================================

class TestUI_CEllipse < TestUI_Class
  ...
  #--------------------------------------------------------------------------
  # * Ellipse which is inactive
  #--------------------------------------------------------------------------
  def test_inactive
    [@window, @sprite, @bitmap].each{|container|
      c = CEllipse.new(container, 150, 50, 50, 25, Color.hp_gauge_color1)
      c.active = false
      c.draw()
    }
    return true
  ...
  #--------------------------------------------------------------------------
  # * Ellipse which is invisible
  #--------------------------------------------------------------------------
  def test_invisible
    [@window, @sprite, @bitmap].each{|container|
      c = CEllipse.new(container, 250, 50, 50, 25, Color.hp_gauge_color1)
      c.visible = false
      c.draw()
    }
    return true
  ...
  def test_gradient
    [@window, @sprite, @bitmap].each{|container|
      c = CEllipse.new(container, 350, 50, 50, 25, Color.hp_gauge_color1, true, Color.hp_gauge_color2)
      c.draw()
    }
    return true
  end
  ...
  #--------------------------------------------------------------------------
  # * Ellipse with a gradient which is inactive
  #--------------------------------------------------------------------------
  def test_inactiveGradient
    [@window, @sprite, @bitmap].each{|container|
      c = CEllipse.new(container, 450, 50, 50, 25, Color.hp_gauge_color1, true, Color.hp_gauge_color2)
      c.active = false
      c.draw()
    }
    return true
  ...
  #--------------------------------------------------------------------------
  # * Ellipse with a border which is inactive
  #--------------------------------------------------------------------------
  ...
  #--------------------------------------------------------------------------
  # * Ellipse with a gradient border
  #--------------------------------------------------------------------------
  def test_gradientBorder
    [@window, @sprite, @bitmap].each{|container|
      c = CEllipse.new(container, 250, 150, 50, 25, Color.gauge_back_color, true, Color.gauge_back_color,
  ...
  #--------------------------------------------------------------------------
  # * Ellipse with a gradient border which is inactive
  #--------------------------------------------------------------------------
  def test_inactiveGradientBorder
    [@window, @sprite, @bitmap].each{|container|
      c = CEllipse.new(container, 350, 150, 50, 25, Color.gauge_back_color, true, Color.gauge_back_color,
          1, Color.hp_gauge_color1, Color.hp_gauge_color2)
      c.active = false
      c.draw()
    }
  ...
  #--------------------------------------------------------------------------
  # * Ellipse not filled with a border
  #--------------------------------------------------------------------------
  ...
  def test_notFilled_gradientBorder
    [@window, @sprite, @bitmap].each{|container|
      c = CEllipse.new(container, 250, 250, 50, 25, nil, false, nil,
          1, Color.hp_gauge_color1, Color.hp_gauge_color2)
      c.draw()
    }
    return true
  ...
  def test_notFilled_inactiveGradientBorder
    [@window, @sprite, @bitmap].each{|container|
      c = CEllipse.new(container, 350, 250, 50, 25, nil, false, nil,
          1, Color.hp_gauge_color1, Color.hp_gauge_color2)
      c.active = false
      c.draw()
    }
